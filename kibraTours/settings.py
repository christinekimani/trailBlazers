"""
Django settings for kibraTours project.
...
SECRET_KEY = 'django-insecure-+ef2j$q*a+aibwwh-u7v3x&tg6!=%-@j55iyd4^!o!tkch_g9h'
...
MIDDLEWARE = [
    ...
    'allauth.account.middleware.Account.Middleware',
]
